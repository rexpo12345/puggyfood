...
function loginMe(){
    ...
    loginUser.open("POST", "https://puggy-auth.auth.us-east-1.amazoncognito.com/login?client_id=97v2lllemim96fti8emqcbr3a&scope=email+openid&redirect_uri=ec2-18-207-43-190.compute-1.amazonaws.com:8080",true);
    ...
    loginUser.onload=function (){
        ...
        console.log(token.result);
            ...
            if (token.result != "invalid") {
                window. location. replace("http://ec2-18-207-43-190.compute-1.amazonaws.com:8080/userProfile.html");
